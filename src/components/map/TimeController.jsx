...
const TimeController = ({ timeOffset, onTimeOffsetChange }) => {
  ...
  return (
    <div className="absolute top-4 right-4 sm:top-8 sm:right-8 bg-white bg-opacity-80 rounded-lg shadow-md p-1 sm:p-2 flex items-center space-x-1 sm:space-x-2 gap-0.5 sm:gap-1">
